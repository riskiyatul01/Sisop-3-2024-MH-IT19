...
int main(int argc, char *argv[]) {
    ...
    if (pid > 0) {
        ...
        char message[150];
        if (strcmp(argv[1], "-kali") == 0) {
            sprintf(message, "hasil perkalian %d dan %d adalah %s.", result, result, kata);
        } else if (strcmp(argv[1], "-tambah") == 0) {
            sprintf(message, "hasil penjumlahan %d dan %d adalah %s.", result, result, kata);
        } else if (strcmp(argv[1], "-kurang") == 0) {
            sprintf(message, "hasil pengurangan %d dan %d adalah %s.", result, result, kata);
        } else {
            sprintf(message, "hasil pembagian %d dan %d adalah %s.", result, result, kata);
        }
